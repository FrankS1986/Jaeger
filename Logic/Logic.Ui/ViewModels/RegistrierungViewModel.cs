...
{
    public class RegistrierungViewModel : ViewModelBase, INotifyPropertyChanged
    {

        private Service serv = new Service();


        public RegistrierungViewModel()
        {
            BBvorname = "#230C0F";
            BBnachname = "#230C0F";
            BBpasswort = "#230C0F"; 
                        ...
                        if (SelectItem != null && !string.IsNullOrEmpty(Tb_vorname) && !string.IsNullOrEmpty(Tb_nachname) && !string.IsNullOrEmpty(Tb_benutzername) && !string.IsNullOrEmpty(Tb_passwort) && !string.IsNullOrEmpty(Tb_sicherheitsfrage_antwort))
                        {
                            ...
                            if (serv.BenutzerVorhanden)
                            {
                                ...
                                var abfrage = new tbl_Abfrage()
                                {
                                    ...
                                    Login_ID = serv.LoginId,
                                    Sicherheitsfragen_ID = serv.SicherheitsfragenId
